...
public class Main {
    public static void main(String[] args) {
        ...
        Cat cat1 = new Cat(2017, "Barsik", "1");
        Cat cat2 = new Cat(2016,"Chak", "2");
        Cat cat3 = new Cat(2015, "Garage", "3");
        Dog dog1 = new Dog(2018, "Mike", "1");
        Dog dog2 = new Dog(2011, "Challanger", "2");
        Dog dog3 = new Dog( 2021, "Kas", "3");
        Owner owner1 = new Owner("Vasia", 1998, "cat1");
        Owner owner2 = new Owner("Alex", 1989, "dog1");
        Owner owner3 = new Owner("Nata", 2005, "cat2");
        Owner owner4 = new Owner("Grace", 1978, "dog2");
        Owner owner5 = new Owner("Chandler", 1973, "cat3");
        Owner owner6 = new Owner("Lucie", 1998,"dog3");
        catList.add(cat1);
        catList.add(cat2);
        catList.add(cat3);
        dogList.add(dog1);
