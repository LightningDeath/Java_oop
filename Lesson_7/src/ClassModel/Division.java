...
public class Division implements i_CalcOperation {
    ...
    public Division(double[] complex) {
    ...
    public double[] calcOperation() {
        this.real = (complex[0]*complex[2]+complex[1]*complex[3])/(complex[2]*complex[2]+complex[3]*complex[3]);
        this.image = (complex[1]*complex[2]-complex[0]*complex[3])/(complex[2]*complex[2]+complex[3]*complex[3]);
